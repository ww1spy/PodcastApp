...
final class zzas extends RemoteMediaPlayer.zzb {
    ...
    public zzas(RemoteMediaPlayer remoteMediaPlayer, GoogleApiClient googleApiClient, GoogleApiClient googleApiClient2, int[] iArr, JSONObject jSONObject) {
        ...
        synchronized (obj) {
            ...
            try {
                try {
                    ...
                    zzbejVar.zza(this.zzezb, this.zzeym, this.zzeyh);
                ...
                setResult((zzas) zzb(new Status(2100)));
                zzaVar2 = this.zzexz.zzexu;
            }
            zzaVar2.zzb(null);
        }
