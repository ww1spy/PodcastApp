...
final class zzax extends RemoteMediaPlayer.zzb {
    ...
    public zzax(RemoteMediaPlayer remoteMediaPlayer, GoogleApiClient googleApiClient, GoogleApiClient googleApiClient2, int i, JSONObject jSONObject) {
        ...
        synchronized (obj) {
            ...
            try {
                try {
                    ...
                    zzbejVar.zza(this.zzezb, 0, -1L, (MediaQueueItem[]) null, 0, Integer.valueOf(this.zzeyf), this.zzeyh);
