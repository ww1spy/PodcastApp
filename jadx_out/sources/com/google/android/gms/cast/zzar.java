...
final class zzar extends RemoteMediaPlayer.zzb {
    ...
    public zzar(RemoteMediaPlayer remoteMediaPlayer, GoogleApiClient googleApiClient, GoogleApiClient googleApiClient2, MediaQueueItem[] mediaQueueItemArr, JSONObject jSONObject) {
        ...
        synchronized (obj) {
            ...
            try {
                try {
                    ...
                    setResult((zzar) zzb(new Status(2100)));
                    zzaVar2 = this.zzexz.zzexu;
                }
                zzaVar2.zzb(null);
            } catch (Throwable th) {
