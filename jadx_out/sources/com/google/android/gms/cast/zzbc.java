...
public final class zzbc extends RemoteMediaPlayer.zzb {
    ...
    public zzbc(RemoteMediaPlayer remoteMediaPlayer, GoogleApiClient googleApiClient, GoogleApiClient googleApiClient2, JSONObject jSONObject) {
        ...
        synchronized (obj) {
            ...
            try {
                try {
                    ...
                    zzbejVar.zzb(this.zzezb, this.zzeyh);
                    zzaVar2 = this.zzexz.zzexu;
                } catch (zzbel | IllegalStateException unused) {
                    setResult((zzbc) zzb(new Status(2100)));
                    zzaVar2 = this.zzexz.zzexu;
                }
                zzaVar2.zzb(null);
            } catch (Throwable th) {
