...
public final class zzbe extends RemoteMediaPlayer.zzb {
    ...
    public zzbe(RemoteMediaPlayer remoteMediaPlayer, GoogleApiClient googleApiClient, GoogleApiClient googleApiClient2, long j, int i, JSONObject jSONObject) {
        ...
        synchronized (obj) {
            ...
            try {
                try {
                    ...
                    zzbejVar.zza(this.zzezb, this.zzeyt, this.zzeyu, this.zzeyh);
                    zzaVar3 = this.zzexz.zzexu;
                } catch (zzbel | IllegalStateException unused) {
                    setResult((zzbe) zzb(new Status(2100)));
                    zzaVar3 = this.zzexz.zzexu;
                }
                zzaVar3.zzb(null);
            } catch (Throwable th) {
