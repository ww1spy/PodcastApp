...
final class zzat extends RemoteMediaPlayer.zzb {
    ...
    public zzat(RemoteMediaPlayer remoteMediaPlayer, GoogleApiClient googleApiClient, GoogleApiClient googleApiClient2, int[] iArr, int i, JSONObject jSONObject) {
        ...
        synchronized (obj) {
            ...
            try {
                try {
                    ...
                    zzbejVar.zza(this.zzezb, this.zzeyn, this.zzeyj, this.zzeyh);
                    zzaVar3 = this.zzexz.zzexu;
                } catch (zzbel | IllegalStateException unused) {
                    setResult((zzat) zzb(new Status(2100)));
                    zzaVar3 = this.zzexz.zzexu;
                }
                zzaVar3.zzb(null);
            } catch (Throwable th) {
