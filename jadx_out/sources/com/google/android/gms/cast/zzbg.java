...
public final class zzbg extends RemoteMediaPlayer.zzb {
    ...
    public zzbg(RemoteMediaPlayer remoteMediaPlayer, GoogleApiClient googleApiClient, GoogleApiClient googleApiClient2, boolean z, JSONObject jSONObject) {
        ...
        synchronized (obj) {
            ...
            try {
                try {
                    ...
                    zzbejVar.zza(this.zzezb, this.zzeyw, this.zzeyh);
                ...
                setResult((zzbg) zzb(new Status(2100)));
                zzaVar2 = this.zzexz.zzexu;
            }
            zzaVar2.zzb(null);
        }
