...
public final class zzbf extends RemoteMediaPlayer.zzb {
    ...
    public zzbf(RemoteMediaPlayer remoteMediaPlayer, GoogleApiClient googleApiClient, GoogleApiClient googleApiClient2, double d, JSONObject jSONObject) {
        ...
        synchronized (obj) {
            ...
            try {
                try {
                    ...
                    zzbejVar.zza(this.zzezb, this.zzeyv, this.zzeyh);
            ...
            } catch (zzbel | IllegalArgumentException | IllegalStateException unused) {
                setResult((zzbf) zzb(new Status(2100)));
                zzaVar2 = this.zzexz.zzexu;
            }
            zzaVar2.zzb(null);
        }
