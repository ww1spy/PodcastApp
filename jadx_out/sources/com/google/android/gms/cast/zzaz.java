...
public final class zzaz extends RemoteMediaPlayer.zzb {
    ...
    public zzaz(RemoteMediaPlayer remoteMediaPlayer, GoogleApiClient googleApiClient, int i, GoogleApiClient googleApiClient2, long j, JSONObject jSONObject) {
        ...
        synchronized (obj) {
            ...
            try {
                try {
                    ...
                    zzbejVar.zza(this.zzezb, this.zzeyr, this.zzeyg, (MediaQueueItem[]) null, 0, (Integer) null, this.zzeyh);
