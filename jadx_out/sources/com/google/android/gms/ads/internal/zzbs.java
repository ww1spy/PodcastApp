...
final class zzbs {
    ...
    public final void zza(zzkk zzkkVar, zzala zzalaVar) {
        this.zzasm = zzkkVar.zzbhc.zzbkm;
        Bundle bundle = zzkkVar.zzbhf != null ? zzkkVar.zzbhf.getBundle(AdMobAdapter.class.getName()) : null;
        if (bundle == null) {
            return;
        }
        ...
        this.zzasl.put("SDKVersion", zzalaVar.zzcu);
    }
