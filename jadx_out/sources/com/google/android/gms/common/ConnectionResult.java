...
public final class ConnectionResult extends zzbgl {
    ...
    public final String toString() {
        return zzbg.zzx(this).zzg("statusCode", getStatusString(this.zzcc)).zzg("resolution", this.zzekd).zzg(SettingsJsonConstants.PROMPT_MESSAGE_KEY, this.zzfqu).toString();
    }
