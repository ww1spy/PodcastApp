...
public final class zzph extends zzqp {
    private static final int zzbxf = Color.rgb(12, 174, IHttpClient.SC_PARTIAL_CONTENT);
    ...
    static {
        int rgb = Color.rgb(IHttpClient.SC_NO_CONTENT, IHttpClient.SC_NO_CONTENT, IHttpClient.SC_NO_CONTENT);
        zzbxg = rgb;
        zzbxh = rgb;
        zzbxi = zzbxf;
    }
