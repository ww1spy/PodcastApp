        ...
        for (Map.Entry<String, String> entry : map.entrySet()) {
            ...
            if (field2 != null) {
                try {
                    ...
                    sb = new StringBuilder(49 + String.valueOf(key).length());
                    ...
                    sb = new StringBuilder(43 + String.valueOf(key2).length());
                    sb.append("Server option \"");
                    sb.append(key2);
                ...
                StringBuilder sb2 = new StringBuilder(31 + String.valueOf(key3).length() + String.valueOf(value).length());
