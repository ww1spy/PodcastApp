...
public interface IDeathCallback_0_8 extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IDeathCallback_0_8 {
        ...
        public static IDeathCallback_0_8 asInterface(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface(DESCRIPTOR);
            if (queryLocalInterface != null && (queryLocalInterface instanceof IDeathCallback_0_8)) {
                return (IDeathCallback_0_8) queryLocalInterface;
            }
