...
public interface IOnSpeedAdjustmentAvailableChangedListenerCallback_0_8 extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IOnSpeedAdjustmentAvailableChangedListenerCallback_0_8 {
        ...
        public static IOnSpeedAdjustmentAvailableChangedListenerCallback_0_8 asInterface(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface(DESCRIPTOR);
            if (queryLocalInterface != null && (queryLocalInterface instanceof IOnSpeedAdjustmentAvailableChangedListenerCallback_0_8)) {
                return (IOnSpeedAdjustmentAvailableChangedListenerCallback_0_8) queryLocalInterface;
            }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            ...
            onSpeedAdjustmentAvailableChanged(parcel.readInt() != 0);
