...
.method private final zza(Ljava/lang/ref/WeakReference;Z)V
    ...
    iget-object v2, p0, Lcom/google/android/gms/internal/zzaaf;->zzaxo:Landroid/util/DisplayMetrics;

    const/4 v3, 0x1

    aget v1, v1, v3

    invoke-static {v2, v1}, Lcom/google/android/gms/internal/zzako;->zzb(Landroid/util/DisplayMetrics;I)I

    move-result v1

    iget-object v2, p0, Lcom/google/android/gms/internal/zzaaf;->mLock:Ljava/lang/Object;

    monitor-enter v2

    :try_start_0
    iget v4, p0, Lcom/google/android/gms/internal/zzaaf;->zzavd:I

    if-ne v4, v0, :cond_3

    iget v4, p0, Lcom/google/android/gms/internal/zzaaf;->zzave:I
    ...
    invoke-interface {p1, v0, v1, p2}, Lcom/google/android/gms/internal/zzapu;->zza(IIZ)V
